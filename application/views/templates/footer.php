		...
		<script type="text/javascript" src="<?php echo base_url(); ?>js/raphael-min.js" charset="utf-8"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/dracula/dracula_graffle.js" ></script>
